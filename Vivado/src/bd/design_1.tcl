# Proc to create BD AXU2CGB_axi_dma
proc cr_bd_AXU2CGB_axi_dma { parentCell } {
...
# End of cr_bd_AXU2CGB_axi_dma()
cr_bd_AXU2CGB_axi_dma ""
set_property REGISTERED_WITH_MANAGER "1" [get_files AXU2CGB_axi_dma.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files AXU2CGB_axi_dma.bd ] 